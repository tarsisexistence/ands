...
describe('[Leetcode] LRUCache', () => {
  test('example #1', () => {
    ...
    expect(cache.put(3, 3)).toBeUndefined(); // evicts key 2
    expect(cache.get(2)).toBe(-1);
    expect(cache.put(4, 4)).toBeUndefined(); // evicts key 1
    expect(cache.get(1)).toBe(-1);
  ...
  test('example #2', () => {
    ...
    ).toEqual([null, -1, null, -1, null, null, 2, 6]);
  });
  ...
  test('example #3', () => {
    ...
    ).toEqual([null, null, null, null, null, -1, 3]);
  });
